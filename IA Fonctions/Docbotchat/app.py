...
if 'messages' not in st.session_state:
    st.session_state['messages'] = [{"role": "assistant", "content": "Bonjour, je suis le Dr. Bot. Comment puis-je vous aider aujourd'hui ?"}]
...
if st.session_state.messages:
    for message in st.session_state.messages:
        role = "Vous" if message["role"] == "user" else "Dr. Bot"
